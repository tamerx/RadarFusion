...
Coordinate calculateP2FromP1BearingDistance(Coordinate p1, double bearing, double distance) {
...
bool isPointInsidePolygon(Coordinate q, std::vector<Coordinate> points)
{
	bool result = false;
...
double CLIPPING_x_intersect(double x1, double y1, double x2, double y2,
...
double CLIPPING_y_intersect(double x1, double y1, double x2, double y2,
	double x3, double y3, double x4, double y4) {
...
void CLIPPING_clip(double poly_points[][2], int &poly_size,
	double x1, double y1, double x2, double y2) {
	double new_points[POLYGON_CLIPPING_MAX_POINTS][2];
	int new_poly_size = 0;
...
std::vector<Coordinate> sutherlandHodgmanClip(std::vector<Coordinate> subject_points_,
	std::vector<Coordinate> clipper_points_) {

	int poly_size = subject_points_.size();
	int clipper_size = clipper_points_.size();

	double poly_points[POLYGON_CLIPPING_MAX_POINTS][2];
	double clipper_points[POLYGON_CLIPPING_MAX_POINTS][2];
